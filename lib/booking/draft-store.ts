...
export async function saveBookingDraft(
  ...
  const draft: BookingDraft = {
    ...
    takeDownLocLength: booking.takeDownLocLength,
    takeDownDensity: booking.takeDownDensity,
    takeDownInstalled: booking.takeDownInstalled,
    takeDownNotes: booking.takeDownNotes,
    restorationLocCount: booking.restorationLocCount,
    restorationLength: booking.restorationLength,
    restorationDescription: booking.restorationDescription,
    startingPriceTier: booking.startingPriceTier,
    depositAmount: booking.depositAmount,
    minimumAppointmentTotal: booking.minimumAppointmentTotal,
    date: booking.date,
...
export function draftToValidatedBooking(draft: BookingDraft): ValidatedBooking {
  return {
    ...
    takeDownLocLength: draft.takeDownLocLength ?? '',
    takeDownDensity: draft.takeDownDensity ?? '',
    takeDownInstalled: draft.takeDownInstalled ?? '',
    takeDownNotes: draft.takeDownNotes ?? '',
    restorationLocCount: draft.restorationLocCount ?? null,
    restorationLength: draft.restorationLength ?? '',
    restorationDescription: draft.restorationDescription ?? '',
    startingPriceTier: draft.startingPriceTier,
    depositAmount: draft.depositAmount,
    minimumAppointmentTotal: draft.minimumAppointmentTotal ?? draft.depositAmount,
    date: draft.date,
